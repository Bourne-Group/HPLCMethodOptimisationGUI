classdef log4m < handle 
    ...
    %
    % Luke Winslow (2021). log4m - A powerful and simple logger for matlab (https://www.mathworks.com/matlabcentral/fileexchange/37701-log4m-a-powerful-and-simple-logger-for-matlab), MATLAB Central File Exchange. Retrieved May 12, 2021.
    %
    ...
    methods (Static)
        function obj = getLogger( logPath )
            ...
            % Code here modified by Thomas Dixon 13/05/21
            localObj = log4m(logPath);
            obj = localObj;
            
            % Code commented out to stop same log file being loaded each
            % time
%             persistent localObj;
